...
const mapToDiveInstruction = (parsedDiveInstruction, diveInstructions) => diveInstructions.push({ direction: parsedDiveInstruction[0], distance: Number.parseInt(parsedDiveInstruction[1], 10) });
